...
, enableStatic ? stdenv.hostPlatform.isStatic, writeScript, testers }:
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url =
      "https://github.com/tukaani-project/xz/archive/refs/heads/master.tar.gz";
    hash = "sha256-0urrCZF6xeMsptKokvyrRNpaOya/Ge68cCmzf7/34v0=";
  };
